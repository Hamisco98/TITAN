...
namespace Titan.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required, MaxLength(100, ErrorMessage = "Max Is 100"), MinLength(2, ErrorMessage = "Min Is 2"), Display(Name = "First Name")]
            public string FirstName { get; set; } = string.Empty;

            [Required, MaxLength(100, ErrorMessage = "Max Is 100"), MinLength(2, ErrorMessage = "Min Is 2"), Display(Name = "Fmaily Name")]
            ...
            [Display(Name = "Joind Date"), DataType(DataType.DateTime)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await _signInManager.UserManager.AddToRoleAsync(user, Const_Data.UserRole);
